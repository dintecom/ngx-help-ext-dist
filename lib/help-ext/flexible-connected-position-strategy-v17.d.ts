 ...
 */
import { ConnectedOverlayPositionChange, ConnectionPositionPair, OverlayContainer, OverlayRef, PositionStrategy } from '@angular/cdk/overlay';
 ...
 * of the overlay.
 */
export declare class FlexibleConnectedPositionStrategy17 implements PositionStrategy {
